...
/**
 * Teleport object containing information required to run
 * a TeleportTask initiated by the Teleport Manager.
 */
public class Teleport {
    ...
    /**
     * Player receiving the Teleport request. Only required for
     * player to player teleportation.
     */
    private Player target;

    /**
     * Location of the Teleport destination. Only required for
     * player to location teleportation.
     */
    private Location location;

    /**
     * Enum constant designating what type of Teleport request
     * should be initiated.
     */
     ...
     */
    public Teleport(Player client, Player target,
                    Location location, TeleportType tpType) {
        this.client = client;
        this.tpType = tpType;
        this.target = target;
